<%@ Page Title="Contact Add Edit" Language="C#" MasterPageFile="~/Content/AddressBook.master" AutoEventWireup="true" CodeFile="ContactPhotoAddEdit.aspx.cs" Inherits="AdminPanel_ContactPhoto_ContactPhotoAddEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        <div class="col-md-12">
            <h2>Contact Photo Add / Edit Page</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
